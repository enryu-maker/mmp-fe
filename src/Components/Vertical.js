...
export default function Vertical({
    ...
    return (
        <button
            ...
            className='h-[180px] w-[92%] lg:w-[350px] lg:h-[200px] bg-white rounded-lg shadow-lg flex flex-row justify-evenly items-center mb-5 '>
            ...
            <div className='flex flex-col h-[95%] w-[55%] justify-between items-start p-2'>
                <h3 className='text-ms w-[90%] font-poppins font-black self-start text-start'>{item?.name}</h3>
                <h3 className='text-xs w-[90%] font-poppins font-bold self-start text-start text-[#145e45]'>RERA No : {item?.reraNo}</h3>
                ...
                <div className='flex w-[90%] justify-between items-center'>
                    ...
                    <div className='flex items-center'>
                        <button className='text-xs lg:text-sm font-poppins font-black self-center text-start ml-1 text-[#145e45]'>View</button>
                    </div>
                </div>
            </div>
        </button>
