...
export default function Horizontal({
    ...
    return (
        <button
            ...
            <h3 className='text-xs lg:text-sm w-[90%] font-nunito font-black self-center text-start '>{item?.name}</h3>
            <h3 className='text-xs w-[90%] font-nunito font-bold self-center text-start text-[#145e45]'>RERA No : {item?.reraNo}</h3>
