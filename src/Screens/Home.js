    ...
    return (
        <div className='bg-[#ebf3eb60] pt-20'>
                    ...
                    banner?.map((item, index) => (
                        <div>
                            ...
                            <button
                                ...
                                className='flex justify-evenly items-center absolute bottom-5 right-5  lg:right-10 font-poppins font-medium  bg-white  px-2 py-1 rounded-lg text-[#145e45]'>
            ...
            <div className=' py-8 flex flex-col items-center justify-center'>
                <h1 className='text-xl lg:text-3xl font-poppins font-black my-5 text-center tracking-wider'>Explore Your Home Sweet Home:  <span className='text-[#145e45] tracking-widest'> Click to Find Your Perfect Property Now!</span> </h1>
                <button 
                onClick={()=>{
                    navigate('/properties')
                }}
                className='flex justify-center items-center bg-[#145e45] text-white font-poppins tracking-wider font-bold px-5 py-2  rounded-lg '>
                    Explore Now
                </button>
                {/* <div className='flex w-full flex-row lg:flex-row items-center justify-evenly lg:justify-center'>
                    ...
                    <button className='flex justify-center items-center bg-[#145e45] text-white font-poppins font-medium h-[40px] w-[12%] lg:h-[50px] lg:w-[50px] rounded-lg lg:ml-5'>
            ...
            <div className='flex flex-col items-center self-center justify-center pt-10 '>
                <h1 className='text-xl  lg:text-3xl font-poppins font-black my-5 text-center text-[#145e45] tracking-widest'>Reviews By Customers . </h1>
                ...
                className='text-ms lg:text-base font-poppins font-bold my-5 text-start bg-[#145e45] text-white tracking-widest p-2.5 rounded-md'>
                    View All
                </button>
            </div>
            ...
            <div className='flex flex-col items-center self-center  justify-center pb-8'>
                <h1 className='text-xl  lg:text-3xl font-poppins font-black my-5 text-center text-[#145e45] tracking-widest'>Blogs . </h1>
                <div className='flex flex-wrap w-full justify-evenly items-center snap-y mt-8'>
                    <FlatList
            ...
            <div className='flex flex-col lg:flex-row items-center self-center justify-evenly pb-8 '>
                <div className='flex flex-col items-center lg:items-start '>
                    <h1 className='text-xl  lg:text-3xl font-poppins font-black my-2 text-center text-[#145e45] tracking-widest'>Didn't Find What You Are Looking For?</h1>
