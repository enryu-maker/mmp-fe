            ...
            <div className='flex flex-col lg:flex-row w-full  justify-evenly items-center space-y-3 '>
                <div className='flex flex-col items-start justify-evenly w-[92%] lg:w-[280px] bg-white rounded-lg shadow-lg p-5'>
                    ...
                    <div className='flex items-center justify-between w-[88%]'>
                        ...
                        <h1 className='text-3xl font-poppins text-indigo-500 font-bold'>{properties.length}</h1>
                    </div>
                </div>
                <div className='flex flex-col items-start justify-evenly w-[92%] lg:w-[280px] bg-white rounded-lg shadow-lg p-5'>
                    ...
                    <div className='flex items-center justify-between w-[88%]'>
                        ...
                        <h1 className='text-3xl font-poppins text-indigo-500 font-bold'>{banner.length}</h1>
                    </div>
                </div>
                <div className='flex flex-col items-start justify-evenly w-[92%] lg:w-[280px] bg-white rounded-lg shadow-lg p-5'>
                    ...
                    <div className='flex items-center justify-between w-[88%]'>
                        ...
                        <h1 className='text-3xl font-poppins text-indigo-500 font-bold'>{blogs.length}</h1>
                    </div>
                ...
                <div className='flex flex-col items-start justify-evenly w-[92%] lg:w-[280px] bg-white rounded-lg shadow-lg p-5'>
                    ...
                    <div className='flex items-center justify-between w-[88%]'>
                        ...
                        <h1 className='text-3xl font-poppins text-indigo-500 font-bold'>{reviews.length}</h1>
                    </div>
                </div>
            </div>
            <div className='flex flex-col w-full  justify-evenly items-center pt-10 '>
                <h1 className='text-3xl font-poppins text-indigo-500 font-bold py-10'>Suggested Properties</h1>
